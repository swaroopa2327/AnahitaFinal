		...
		<div id="myCarousel" class="carousel slide " data-ride="carousel"
			...
			<div class="carousel-inner">
				<div class="item active">
					<img  class ="img-responsive" src="resources/images/ban4.jpg" alt="garden" />
				...
				<div class="item">
					<img class ="img-responsive" src="resources/images/ban2.jpg" alt="flowers" />
				...
				<div class="item">
					...
					<img  class ="img-responsive" src="resources/images/ban1.jpg" alt="indoors" />
					<div class="carousel-caption">
						<h2 id="flowersSlider">
				...
				<div class="item">
					<img  class ="img-responsive" src="resources/images/cover4.jpg" alt="pots" />
					<div class="carousel-caption">
						<h2>
